export const productsBR = [
  ...
  },
  {
    ...
    stars: 4.8,
    description:
      'O Fire TV Stick transforma sua TV em uma central multimídia inteligente. Versão com Controle remoto, com Alexa.',
    url: 'https://amzn.to/4ggDtd6',
    image: 'https://m.media-amazon.com/images/I/61qQCckVsqL._AC_SX679_.jpg',
    category: 'Eletrônicos',
  },
  {
  ...
  },
  {
    ...
    stars: 4.8,
    description:
      'O leitor de livros digitais definitivo. Na sua edição mais popular. Simples, compacto e leve, como deve ser.',
    url: 'https://amzn.to/4gBRXEc',
