  ...
  const banners = [
    {
      ...
      title: 'Compra segura',
      subtitle:
        'Produtos bem avaliados, com garantia e entregues pelas lojas Mercado Livre, Amazon ou AliExpress.',
      image: <IconShield />,
    },
    {
      ...
      title: 'Receba R$ 5,00',
      subtitle:
        'Ainda não recebe cashback? Ative o Méliuz e ganhe dinheiro de volta nas compras!',
      image: <IconGift />,
    },
  ]
