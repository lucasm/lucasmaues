...
export const ROUTES = {
  HOME: {
    ...
    title: 'Lucas Maués',
    description:
      'Lucas Maués de Menezes is a Brazilian Founder, Tech Lead & Senior Frontend Engineer, with 8+ years of experience.',
    seo: 'Founder, Tech Lead & Senior Frontend Engineer',
    image: DEFAULT_IMAGE,
  },
  ABOUT: {
    path: '/#about',
  ...
  WORK: {
    path: '/work',
    title: 'Work',
    description: "I'm leading teams to build scalable platforms and products.",
    image: DEFAULT_IMAGE,
  },
  CONTACT: {
    path: '/contact',
